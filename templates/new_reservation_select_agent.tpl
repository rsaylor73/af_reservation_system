...
function step4(resellerID,reseller_agentID,reservation_sourceID,charterID,userID,reservation_type,myform) {
        $.get('/ajax/new_reservation_step4.php?resellerID='+resellerID+'&reseller_agentID='+reseller_agentID+'&reservation_sourceID='+reservation_sourceID+'&charterID='+charterID+'&userID='+userID+'&reservation_type='+reservation_type,
