<div class="modal-header">
	<button type="button" onclick="javascript:window.location.reload()" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Add Travel Plans</h4>
</div>

<form name="myform1" action="/index.php" method="POST">
<input type="hidden" name="section" value="reservations_save_aat_plans">
...
<div class="modal-body">
	<div class="te">
		...
		<div class="row pad-top">
			...
			<div class="col-sm-6"><input type="number" name="amount" class="form-control"></div>
		</div>
