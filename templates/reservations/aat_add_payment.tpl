...
<input type="hidden" name="section" value="reservations_save_aat_payment">
...
<div class="modal-body">
	<div class="te">
		...
		<div class="row pad-top">
			...
			<div class="col-sm-6"><input type="text" name="payment_date" class="form-control date" required></div>
		</div>
