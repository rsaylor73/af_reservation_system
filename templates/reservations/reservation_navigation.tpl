<ul class="nav nav-pills">
        ...
        <li role="presentation" class="{$t4}"><a href="/reservations_notes/{$reservationID}">Notes</a></li>
        <li role="presentation" class="{$t5}"><a href="/reservations_options/{$reservationID}">Options</a></li>
