...
<div class="well">
	<div class="row pad-top">
		<div class="col-sm-12">
			<div class="alert alert-warning">Click on a reseller to select an agent</div>
		</div>
	</div>
...
function step3(resellerID,reservation_sourceID,charterID,userID,reservation_type,myform) {
        $.get('/ajax/new_reservation_step3.php?resellerID='+resellerID+'&reservation_sourceID='+reservation_sourceID+'&charterID='+charterID+'&userID='+userID+'&reservation_type='+reservation_type,
