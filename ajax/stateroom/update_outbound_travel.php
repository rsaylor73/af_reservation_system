...
if ($logged == "TRUE") {
	...
	if (is_array($_GET['outbound'])) {
		foreach ($_GET['outbound'] as $flight_id=>$value) {
			$airport = $_GET['outbound'][$flight_id]['airport'];
			$airline = $_GET['outbound'][$flight_id]['airline'];
			$flight = $_GET['outbound'][$flight_id]['flight'];
			$date = $_GET['outbound'][$flight_id]['date'];
			$delete = $_GET['outbound'][$flight_id]['delete'];
