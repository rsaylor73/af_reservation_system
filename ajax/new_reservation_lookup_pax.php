...
if ($logged == "TRUE") {
        ...
        while ($row = $result->fetch_assoc()) {
                $output .= "
                <tr onclick=\"assign_pax('$_GET[inventoryID]','$row[contactID]')\">
	...
	<div class=\"row pad-top\">
		<div class=\"col-sm-12\">
			<div class=\"alert alert-info\">Click on the contact's name to assign as the passenger.</div>
		</div>
	</div>
	...
	<div class=\"row pad-top\">
        	<div class=\"col-sm-12\">
			<input type=\"button\" value=\"Change Passenger\" class=\"btn btn-primary\" onclick=\"search_pax('$inventory')\">&nbsp;&nbsp;
